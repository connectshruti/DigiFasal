    ...
    return (
      ...
      >
        <div
          ...
          className={cn(
            "relative",
            variant === "nature" && "border border-green-100 rounded-xl p-1",
            className
          )}
          role="region"
  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "nature" && "rounded-lg overflow-hidden border border-gray-100",
        className
      )}
      {...props}
    />
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        carouselVariant === "nature" ? "bg-green-50 border-green-200 text-green-600" : "bg-white border-gray-300",
        orientation === "horizontal"
